...
==== Exiting the program : `exit` (Daniel)
...
[[budget-command]]
//tag::walletbudget[]
==== Setting a budget: `budget` (Daniel)
...
[[add-expense-command]]
//tag::walletexpense[]
==== Adding an expense: `expense` (Joel)
...
//tag::walletedit[]
==== Editing a transaction: `edit` (Grace)
...
//tag::walletdelete[]
==== Deleting an income or expense: `delete` (Grace)
...
//tag::walletfind[]
[[walletFind]]
==== Finding an income or expense: `find` (Grace)
...
//tag::walletList[]
==== Listing all transactions: `list` (Joel)
...
// tag::walletClear[]
[[walletClear]]
==== Clearing all transactions : `clear` (Daniel)
...
// tag::edit[]
[[edit-person]]
==== Editing a person : `edit` (Cheyanne)
...
// tag::delete[]
[[delete-person]]
==== Deleting a person : `delete` (Grace)
...
// tag::owe[]
==== Recording the money you owe: `owe` (Cheyanne)
...
// tag::return[]
==== Recording the money you return: `returned` (Cheyanne)
...
// tag::lend[]
==== Recording the money you lend: `lend` (Cheyanne)
...
// tag::peoplereceived[]
==== Recording the money you received: `received` (Cheyanne)
...
//tag::peopleremind[]
==== Sending reminder to a friend: `remind` (Syin Yi)
...
//tag::peopleremindall[]
==== Sending reminder to all friends: `remindall` (Syin Yi)
...
//tag::peoplelist[]
[[list-people]]
==== Listing all contacts: `list` (Syin Yi)
...
// tag::peopleclear[]
[[peopleclear]]
==== Clearing all contacts : `clear` (Syin Yi)
